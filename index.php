...
<html lang="en">
  <head>
    ...
    <title> Website Sistem Informasi Akademik Jurusan Teknik Informatika </title>
      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            ...
            <center>
            &nbsp; <a href="index.php" class="fa fa-mortar-board fa-2x" style="color:#fff;"><span><font size="2.95" color="white" face="Helvetica Neue">Website Informasi Akademik Jurusan Teknik Informatika</font></span></a>
            </center>
            </div>
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="assets/images/pengguna.jpeg" alt="..." class="img-circle profile_img">
              </div>
              <div class="profile_info">
                <span>Selamat Datang,</span>
                <h2>Balqis Nur Aura Shaviradilla</h2>
              </div>
            </div>
            <!-- /menu profile quick info -->
            <br />
              ...
              <ul class=" navbar-right">
                <li class="nav-item dropdown open" >
                  <a href="#" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                    <img src="assets/images/user.png" alt="">Balqis Nur Aura Shaviradilla
                  </a>
                  <div class="dropdown-menu dropdown-usermenu pull-right" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item"  href="#"><span class="badge bg-green pull-right">Sistem Informasi</span>Prodi</a>
                      <a class="dropdown-item"  href="#">
                        <span class="badge bg-red pull-right">21051214028</span>
                        <span>Nim</span>
                      </a>
      ...
      switch ($queries['page']) {
        ...
        <footer>
          <div class="pull-right">
            Copyright @ 2022 Website Informasi Akademik Jurusan Teknik Informatika : Balqis Nur Aura Shaviradilla
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
